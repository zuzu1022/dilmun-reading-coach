...
namespace DilmunReadingCoach.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReadingProgress_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingProgress_StudentId_WeekStartDate",
                table: "ReadingProgress",
                columns: new[] { "StudentId", "WeekStartDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReportCaches_ReportType_ScopeId_PeriodStart_PeriodEnd",
                table: "ReportCaches",
                columns: new[] { "ReportType", "ScopeId", "PeriodStart", "PeriodEnd" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_ClassroomId_Status",
                table: "Students",
